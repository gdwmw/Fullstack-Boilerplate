...
export interface ApiDataData extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::data.data"> & Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.DefaultTo<"User Account">;
    phoneNumber: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.DefaultTo<"0000000000">;
    publishedAt: Schema.Attribute.DateTime;
    relation_user: Schema.Attribute.Relation<"oneToOne", "plugin::users-permissions.user">;
    role: Schema.Attribute.Enumeration<["demo", "user", "admin", "superadmin"]> & Schema.Attribute.Required & Schema.Attribute.DefaultTo<"user">;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
}
...
export interface PluginUsersPermissionsUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    relation_data: Schema.Attribute.Relation<"oneToOne", "api::data.data">;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<"manyToOne", "plugin::users-permissions.role">;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
